...
export default function Home() {
  return (
    <div className="w-[100%] h-[100%] flex justify-center items-center bg-white dark:bg-purple-black-2">
      <div className="w-[1140px] flex justify-center gap-12 max-lg:gap-5 max-md:flex-col max-md:items-center">
        <div className="">
