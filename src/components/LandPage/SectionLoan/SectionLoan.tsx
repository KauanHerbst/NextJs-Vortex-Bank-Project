    ...
    <section className="container h-[548px]">
      ...
      <div className="flex-item-2 flex flex-col ">
        <div className="relative max-xl:flex max-md:flex-col max-md:items-center">
          <div
            className="bg-purple-black-primary border-[1px] border-blue-black-2 shadow-md shadow-blue-primary rounded-md w-64 h-72 p-4 flex flex-col items-center absolute top-[-280px] max-xl:static max-xl:top-0"
            data-aos="fade-up"
            data-aos-duration="2000"
            data-aos-delay="300"
            data-aos-anchor-placement="top-center"
          ...
          <div
            className="bg-purple-black-primary border-[1px] border-blue-black-2 shadow-md shadow-blue-primary rounded-md w-64 h-72 p-4 flex flex-col items-center absolute right-[50px] top-[-170px] max-xl:static max-xl:top-0 max-xl:right-0 max-xl:ml-8 max-md:ml-0 max-md:mt-5"
            data-aos="fade-up"
            data-aos-duration="2000"
            data-aos-delay="400"
            data-aos-anchor-placement="top-center"
        ...
        <div className="relative max-xl:flex max-xl:mt-8 max-md:flex-col max-md:items-center">
          <div
            className="bg-purple-black-primary border-[1px] border-blue-black-2 shadow-md shadow-blue-primary rounded-md w-64 h-72 p-4 flex flex-col items-center absolute top-[70px] max-xl:static max-xl:top-0 "
            data-aos="fade-up"
            data-aos-duration="2000"
            data-aos-delay="300"
            data-aos-anchor-placement="top-center"
          ...
          <div
            className="bg-purple-black-primary border-[1px] border-blue-black-2 shadow-md shadow-blue-primary rounded-md w-64 h-72 p-4 flex flex-col items-center absolute top-[190px] right-[50px] max-xl:static max-xl:top-0 max-xl:right-0 max-xl:ml-8 max-md:ml-0 max-md:mt-5"
            data-aos="fade-up"
            data-aos-duration="2000"
            data-aos-delay="400"
